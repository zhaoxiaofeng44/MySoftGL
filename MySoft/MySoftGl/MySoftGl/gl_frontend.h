...
union gl_atrribute
{
    ...
    gl_atrribute() {values[0] = 0;values[1] = 0;values[2] = 0;values[3] = 0;}
	gl_atrribute(T _x, T _y, T _z, T _w) {values[0] = 0;values[1] = 0;values[2] = 0;values[3] = 0;}
};
...
struct gl_atrribute_pointer
{
	...
	GLenum	type;
	GLsizei stride;
	gl_atrribute_pointer() :pointer(0) {}
};
