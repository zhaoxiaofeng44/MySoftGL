...
n_hidden_3 = 64 # 第二个隐藏层神经元格式
n_hidden_4 = 16 # 第二个隐藏层神经元格式
n_hidden_5 = 1 # 第二个隐藏层神经元格式
...
weights = {
    ...
    'decoder_h5': tf.Variable(tf.random_normal([n_hidden_1, n_input])),
}
biases = {
...
with tf.Session() as sess:
    ...
    flagtest = sess.run(
        flag_op, feed_dict={X: mnist.test.images[:examples_to_show]})
    print(flagtest)
